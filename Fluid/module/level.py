...
class Level(object):
    ...
    def __init__(self, high=None, low=None, mediumtype='', path=None, quota=None, quota_list=None, _configuration=None):  # noqa: E501
    ...
    def mediumtype(self, mediumtype):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and mediumtype is None:
