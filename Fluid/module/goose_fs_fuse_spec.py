...
class GooseFSFuseSpec(object):
    ...
    def __init__(self, annotations=None, args=None, clean_policy=None, env=None, _global=None, image=None, image_pull_policy=None, image_tag=None, jvm_options=None, node_selector=None, properties=None, resources=None, _configuration=None):  # noqa: E501
        """GooseFSFuseSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def resources(self):
        ...
        Resources that will be requested by GooseFS Fuse. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GooseFSFuseSpec, dict):
