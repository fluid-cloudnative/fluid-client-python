...
class JindoFuseSpec(object):
    ...
    def __init__(self, args=None, clean_policy=None, env=None, _global=None, image=None, image_pull_policy=None, image_tag=None, labels=None, node_selector=None, properties=None, resources=None, tolerations=None, _configuration=None):  # noqa: E501
        """JindoFuseSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def labels(self):
        ...
        Labels will be added on all the JindoFS Fuse pods. Any label already existed will be overriden  # noqa: E501
    ...
    def resources(self):
        ...
        Resources that will be requested by Jindo Fuse. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JindoFuseSpec, dict):
