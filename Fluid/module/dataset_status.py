...
class DatasetStatus(object):
    ...
    def __init__(self, cache_states=None, conditions=None, data_backup_ref=None, data_load_ref=None, file_num=None, hcfs=None, mounts=None, phase=None, runtimes=None, ufs_total=None, _configuration=None):  # noqa: E501
