...
class RuntimeStatus(object):
    ...
    def current_fuse_number_scheduled(self, current_fuse_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and current_fuse_number_scheduled is None:
    ...
    def current_master_number_scheduled(self, current_master_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and current_master_number_scheduled is None:
    ...
    def current_worker_number_scheduled(self, current_worker_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and current_worker_number_scheduled is None:
    ...
    def desired_fuse_number_scheduled(self, desired_fuse_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and desired_fuse_number_scheduled is None:
    ...
    def desired_master_number_scheduled(self, desired_master_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and desired_master_number_scheduled is None:
    ...
    def desired_worker_number_scheduled(self, desired_worker_number_scheduled):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and desired_worker_number_scheduled is None:
    ...
    def fuse_number_ready(self, fuse_number_ready):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and fuse_number_ready is None:
    ...
    def fuse_phase(self, fuse_phase):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and fuse_phase is None:
    ...
    def master_number_ready(self, master_number_ready):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and master_number_ready is None:
    ...
    def master_phase(self, master_phase):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and master_phase is None:
    ...
    def mount_time(self):
        ...
        MountTime represents time last mount happened if Mounttime is early than master starting time, remount will be required  # noqa: E501
    ...
    def value_file(self, value_file):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and value_file is None:
    ...
    def worker_number_ready(self, worker_number_ready):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and worker_number_ready is None:
    ...
    def worker_phase(self, worker_phase):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and worker_phase is None:
