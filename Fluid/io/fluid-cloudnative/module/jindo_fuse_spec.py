...
class JindoFuseSpec(object):
    ...
    def __init__(self, args=None, env=None, _global=None, image=None, image_pull_policy=None, image_tag=None, node_selector=None, properties=None, resources=None):  # noqa: E501
