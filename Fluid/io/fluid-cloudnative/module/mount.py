...
from Fluid.io.fluid-cloudnative.module.encrypt_option import EncryptOption  # noqa: F401,E501
...
class Mount(object):
    ...
    def __init__(self, encrypt_options=None, mount_point=None, name=None, options=None, path=None, read_only=None, shared=None):  # noqa: E501
