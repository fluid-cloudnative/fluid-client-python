...
import fluid
from fluid.models.data_process_spec import DataProcessSpec  # noqa: E501
from fluid.rest import ApiException

class TestDataProcessSpec(unittest.TestCase):
    """DataProcessSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DataProcessSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = fluid.models.data_process_spec.DataProcessSpec()  # noqa: E501
        if include_optional :
            return DataProcessSpec(
