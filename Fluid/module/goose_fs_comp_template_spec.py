...
class GooseFSCompTemplateSpec(object):
    ...
    def __init__(self, annotations=None, enabled=None, env=None, jvm_options=None, node_selector=None, ports=None, properties=None, replicas=None, resources=None, _configuration=None):  # noqa: E501
        """GooseFSCompTemplateSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def resources(self):
        ...
        Resources that will be requested by the GooseFS component. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GooseFSCompTemplateSpec, dict):
